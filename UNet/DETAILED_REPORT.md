...
- Report: `<REPO_ROOT>/UNet/DETAILED_REPORT.md`
- Bandpass run log: `<REPO_ROOT>/UNet/BP_46141511.out`
- Bandpass best ckpt: `<REPO_ROOT>/UNet/checkpoints_bp/best_model.pt`
- Bandpass inference text: `<REPO_ROOT>/UNet/inference_output_bp/transcriptions.txt`
- UNet-CTC train log: `<REPO_ROOT>/UNet/UNet-CTC/UNet_CTC_46225507.out`
- UNet-CTC inference summary: `<REPO_ROOT>/UNet/UNet-CTC/inference_output/results.json`
