...
cfg14, m14 = load('<REPO_ROOT>/soundbar_setup/M14_new_setup_soundbar_melgen',
                  '<REPO_ROOT>/soundbar_setup/M14_new_setup_soundbar_melgen/outputs/cluster_a100/last.pt')
@torch.no_grad()
def enc14(x):
...
cfg15, m15 = load('<REPO_ROOT>/soundbar_setup/M15_soundbar_melgen_word',
                  '<REPO_ROOT>/soundbar_setup/M15_soundbar_melgen_word/outputs/run1/best.pt')
@torch.no_grad()
def enc15(x):
