#!/bin/bash
#SBATCH --job-name=M4_PerceptualLoss
...
echo "========================================"
echo "Module 4: UNet + Perceptual Loss"
...
echo ""
echo "========================================"
echo "Step 1: Preparing bandpass data"
echo "========================================"
...
# ── Step 2: Train UNet with perceptual loss ─────────────────────────────────
echo ""
echo "========================================"
