...
dataset.py
----------
PyTorch Dataset for cascade pipeline.
Same format as E2E: returns (noisy_mel, clean_mel, text_encoded, text_length).
Reuses the same e2e_data.npz produced by E2E/prepare_data.py.
"""
