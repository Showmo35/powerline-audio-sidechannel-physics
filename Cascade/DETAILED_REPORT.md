...
Project path: `<REPO_ROOT>/Cascade`
...
- Project root: `<REPO_ROOT>/Cascade`
- Report: `<REPO_ROOT>/Cascade/DETAILED_REPORT.md`
- Main training log: `<REPO_ROOT>/Cascade/Cascade_Train_46188287.out`
- Inference summary: `<REPO_ROOT>/Cascade/inference_output/summary.json`
- Comparison log: `<REPO_ROOT>/Cascade/Infer_All_46188288.out`
