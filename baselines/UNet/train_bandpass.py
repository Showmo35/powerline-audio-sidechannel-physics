...
train_bandpass.py
-----------------
Train PowerlineUNet on bandpass-filtered data. L1 + Multi-Scale STFT loss.
No Whisper dependency.

Usage:
    python train_bandpass.py
    python train_bandpass.py --data data/train_data_bp.npz --out checkpoints_bp
"""
...
from model_bandpass import PowerlineUNet, GeneratorLoss
from dataset import make_dataloaders

_HERE      = os.path.dirname(os.path.abspath(__file__))
LOCAL_DATA = os.path.join(_HERE, "data", "train_data_bp.npz")
LOCAL_OUT  = os.path.join(_HERE, "checkpoints_bp")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train PowerlineUNet (bandpass)")
