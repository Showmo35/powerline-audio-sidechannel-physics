...
prepare_data.py
---------------
Prepare training data for CTC transcription on UNet-predicted spectrograms.

Pipeline per chapter:
  1. Bandpass filter raw powerline signal (50-4000 Hz)
  2. Downsample to 16 kHz
  3. Window at 5-sec / 1-sec hop (same as E2E)
...
def main(args):
    ...
    print(f"\nUNet Transcribe Data Preparation")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--unet_ckpt',
        default=os.path.join(os.path.dirname(_HERE), 'checkpoints_bp', 'best_model.pt'))
