"""
prepare_data_bandpass.py
------------------------
Bandpass pipeline: filters the raw powerline signal at 50-4000 Hz
(where speech modulates the 60 Hz harmonics), downsamples to 16 kHz,
and computes Whisper-format log-mel spectrograms.

No IQ demodulation — the speech information is in the amplitude
modulation of the low-frequency power line harmonics, not at a
carrier frequency.

Usage:
    python prepare_data_bandpass.py
    python prepare_data_bandpass.py --split random --out_name train_data_bp_random.npz
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--split', default='random', choices=['temporal', 'random'])
    parser.add_argument('--out_name', default='train_data_bp.npz')
