...
#SBATCH --mem=32GB
#SBATCH --output=Train_E2E_CTC_%j.out
#SBATCH --error=Train_E2E_CTC_%j.err
...
# Retrain CTC-only baseline with temporal split data for fair comparison
