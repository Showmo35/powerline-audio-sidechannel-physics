...
Project path: `<REPO_ROOT>/Experiments`
...
- Report: `<REPO_ROOT>/Experiments/DETAILED_REPORT.md`
- Main comparison: `<REPO_ROOT>/Experiments/results/comparison.txt`
- Summary JSON: `<REPO_ROOT>/Experiments/results/summary.json`
- Inference fix log: `<REPO_ROOT>/Experiments/Exp_Infer_46228965.out`
