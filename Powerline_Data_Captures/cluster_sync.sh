#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# cluster_sync.sh  –  Upload new files from local bin_captures → cluster scratch storage
#
# Usage:
...
LOCAL_DIR="$HOME/Documents/power/bin_captures"
CLUSTER_USER="user"
CLUSTER_HOST="<cluster_login_host>"
REMOTE_DIR="<REPO_ROOT>/Powerline_Data_Captures/Soundbar/LibriSpeech"
POLL_INTERVAL=600
